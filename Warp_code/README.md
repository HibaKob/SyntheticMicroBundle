# SyntheticMicroBundle: Warping Code
This folder contains the files to generate textured synthetic data of beating microbundles. All files were tested in `Python 3.9.13`.
## In this Folder
